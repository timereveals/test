/**
 * @summary     SelectPagearr
 * @desc        Simple and powerful selection plugin
 * @file        SelectPagearr.js
 * @version     2.18
 * @author      TerryZeng
...
;(function($){
	...
	/**
     * SelectPagearr class definition
	 * @constructor
	 * @param {Object} input - input element
	 * @param {Object} option
	 */
	var SelectPagearr = function(input, option) {
	 ...
	 */
	SelectPagearr.version = '2.18';
	/**
	 * Plugin object cache key
	 */
	SelectPagearr.dataKey = 'SelectPagearrObject';
	/**
	 * Options set
	 * @param {Object} option
	 */
	SelectPagearr.prototype.setOption = function(option) {
	 ...
	 * @return {Array}
	 */
	SelectPagearr.prototype.strToArray = function(str) {
		if(!str) return '';
	 ...
	 * @return {Array}
	 */
	SelectPagearr.prototype.setOrderbyOption = function(arg_order, arg_field) {
		var arr = [],orders = [];
	 ...
	 * i18n
	 */
	SelectPagearr.prototype.setLanguage = function() {
	 ...
	 */
	SelectPagearr.prototype.setCssClass = function() {
		var css_class = {
	 ...
	 */
	SelectPagearr.prototype.setProp = function() {
		this.prop = {
     ...
     * @returns {*}
     */
    SelectPagearr.prototype.elementRealSize = function(element, method){
        var defaults = {
            absolute       : false,
            clone          : false,
            includeMargin : false,
	 ...
	 */
	SelectPagearr.prototype.setElem = function(combo_input) {
		// 1. build Dom object
		...
		var namePrefix = '_text',
		    ...
		    input_name = elem.combo_input.attr('name') || 'SelectPagearr',
	 ...
	 */
	SelectPagearr.prototype.setButtonAttrDefault = function() {
	    /*
     ...
     * <input data-init="key">
	 */
	SelectPagearr.prototype.setInitRecord = function(refresh) {
	 ...
	 */
	SelectPagearr.prototype.afterInit = function(self, data) {
	 ...
	 */
	SelectPagearr.prototype.eDropdownButton = function() {
		var self = this;
	 ...
	 * Events bind
	 */
	SelectPagearr.prototype.eInput = function() {
		...
		el.container.on('click.SelectPagearr','div.'+self.css_class.clear_btn,function(e){
            e.stopPropagation();
		...
		el.result_area.on('mousedown.SelectPagearr',function(e){
		    e.stopPropagation();
        });
		if(p.multiple){
			if(p.multipleControlbar){
				//Select all item of current page
                el.control.find('.sp_select_all').on('click.SelectPagearr',function(e){
                ...
                el.control.find('.sp_unselect_all').on('click.SelectPagearr',function(e){
                ...
                el.control.find('.sp_clear_all').on('click.SelectPagearr',function(e){
					self.clearAll(self);
				}).hover(function(){
			...
			el.element_box.on('click.SelectPagearr',function(e){
				var srcEl = e.target || e.srcElement;
				if($(srcEl).is('ul')) el.combo_input.focus();
			});
			//Tag close
			el.element_box.on('click.SelectPagearr','span.tag_close',function(){
	 ...
	 */
	SelectPagearr.prototype.eWhole = function() {
		...
		//Out of plugin area
		$(document.body).off('mousedown.SelectPagearr').on('mousedown.SelectPagearr',function(e) {
            var ele = e.target || e.srcElement;
            var sp = $(ele).closest('div.' + css.container);
            //Open status result list
            $('div.' + css.container + '.' + css.container_open).each(function(){
                if(this == sp[0]) return;
                var $this = $(this), d = $this.find('input.' + css.input).data(SelectPagearr.dataKey);
	 ...
	 */
	SelectPagearr.prototype.eResultList = function() {
     ...
     */
	SelectPagearr.prototype.eScroll = function(){
	    var self = this, css = this.css_class;
	    $(window).on('scroll.SelectPagearr',function(e){
            $('div.' + css.container + '.' + css.container_open).each(function(){
                var $this = $(this), d = $this.find('input.'+css.input).data(SelectPagearr.dataKey),
	 ...
	 */
	SelectPagearr.prototype.ePaging = function() {
		var self = this;
	 ...
	 */
	SelectPagearr.prototype.ajaxErrorNotify = function(self, errorThrown) {
	 ...
	 */
	SelectPagearr.prototype.showMessage = function(self,msg){
		if(!msg) return;
	 ...
	 */
	SelectPagearr.prototype.scrollWindow = function(self, enforce) {
     ...
     */
	SelectPagearr.prototype.setOpenStatus = function(self, status){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.setCssFocusedInput = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.setCssFocusedResults = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.checkValue = function(self) {
     ...
     */
    SelectPagearr.prototype.processKey = function(self, e) {
	 ...
	 * @param {Object} e - event object
	 */
	SelectPagearr.prototype.processControl = function(self, e) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.abortAjax = function(self) {
		if (self.prop.xhr) {
			self.prop.xhr.abort();
			self.prop.xhr = false;
		}
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.suggest = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.setLoading = function(self) {
	 ...
	 */
	SelectPagearr.prototype.searchForDb = function(self, q_word, which_page_num) {
	    var p = self.option;
	 ...
	 */
	SelectPagearr.prototype.searchForJson = function(self, q_word, which_page_num) {
	 ...
	 */
	SelectPagearr.prototype.sortAsc = function(self, arr) {
	 ...
	 * @param {Array} arr - result array
	 */
	SelectPagearr.prototype.sortDesc = function(self, arr) {
		arr.sort(function(a, b) {
            var valA = a[self.option.orderBy[0][0]], valB = b[self.option.orderBy[0][0]];
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.notFoundSearch = function(self) {
	 ...
	 * @param {number} which_page_num - target page number
	 */
	SelectPagearr.prototype.prepareResults = function(self, json, q_word, which_page_num) {
	 ...
	 */
	SelectPagearr.prototype.setNavi = function(self, cnt_whole, cnt_page, page_num) {
	 ...
	 */
	SelectPagearr.prototype.displayResults = function(self, json, is_query) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.calcResultsSize = function(self) {
	    var p = self.option, el = self.elem;
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.hideResults = function(self) {
        ...
        $(window).off('scroll.SelectPagearr');
     ...
     * @param disabled
     */
	SelectPagearr.prototype.disabled = function(self, disabled){
	    var p = self.option, el = self.elem;
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.firstPage = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.prevPage = function(self) {
		if (self.prop.current_page > 1) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.nextPage = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.lastPage = function(self) {
		if (self.prop.current_page < self.prop.max_page) {
     ...
     * @param {Object} self
	 */
	SelectPagearr.prototype.afterAction = function(self){
		self.inputResize(self);
	 ...
	 */
	SelectPagearr.prototype.selectCurrentLine = function(self, is_enter_key) {
		self.scrollWindow(self, true);
     ...
     */
	SelectPagearr.prototype.putClearButton = function(){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.selectAllLine = function(self){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.unSelectAllLine = function(self){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.clearAll = function(self){
     ...
     * reset
     */
	SelectPagearr.prototype.reset = function(self){
        self.elem.combo_input.val('');
        self.elem.hidden.val('');
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.getCurrentLine = function(self) {
	 ...
	 */
	SelectPagearr.prototype.isAlreadySelected = function(self,item){
		var isExist = false;
		if(item.value){
	 ...
	 * @param {Object} item
	 */
	SelectPagearr.prototype.addNewTag = function(self,item){
	 ...
	 * @param {Object} item
	 */
	SelectPagearr.prototype.removeTag = function(self,item){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.tagValuesSet = function(self){
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.inputResize = function(self){
		if(!self.option.multiple) return;
		var width = '',
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.nextLine = function(self) {
	 ...
	 * @param {Object} self
	 */
	SelectPagearr.prototype.prevLine = function(self) {
		var obj = self.getCurrentLine(self), idx;
	...
	/**
	 * SelectPagearr plugin definition
	 * @global
	...
	function Plugin(option) {
		return this.each(function(){
			var $this = $(this),
				data = $this.data(SelectPagearr.dataKey),
				params = $.extend({}, defaults, $this.data(), data && data.option ,typeof option === 'object' && option);
			if(!data) $this.data(SelectPagearr.dataKey,(data =  new SelectPagearr(this,params)));
		});
	}
	 ...
	 * Refresh result list
     * use case:
     * 1.use $(obj).val('xxx') to modify SelectPagearr selected item key
